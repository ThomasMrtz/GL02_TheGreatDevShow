  ...
  simulate() {
    ...
    while (cpt < this.questions.length) {
      do {
        ...
        var nb = prompt(
          "Which question you want to respond to? (Type a number): "
        );
      ...
      this.questions[nb].visualiseForStudents();
      ...
      switch (qtype) {
        ...
        case "Matching":
          for (
            let d = 0;
            d < this.questions[nb].correct_answer[0].length;
            d++
          ) {
    ...
    for (let n = 0; n < responses.length; n++) {
      ...
      if (checked == true) {
        ...
        console.log(
          "Wrong answer for the Question n°",
          n,
          "your response was",
          responses[n],
          "but the solution was",
          this.questions[n].correct_answer
        );
      }
    }
  }
